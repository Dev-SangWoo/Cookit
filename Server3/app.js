...
const youtubeAnalysisRoutes = require('./routes/youtubeAnalysis');
const receiptListRoutes = require('./routes/receiptList');
...
app.use('/api/youtube-analysis', youtubeAnalysisRoutes);
